...
const EditMovie = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post("http://localhost:3001/upload", formData)
            .then( (response) => {
                ...
                axios.put(`http://localhost:3001/movies/${params.id}`, {
                    title: title,
    ...
    return ( 
        ...
        <div className="text-center m-2 ">
                <h2 className="fs-1 fw-bold text-light">Edit a Movie</h2>
        </div>
        <div className="d-flex flex-row  m-4">
            ...
            <Col className="col-lg-4 d-flex flex-column justify-content-center">
                ...
                <div>
                    {!fileChanged && <Image src={`http://localhost:3001/images/${filename}`} height={"400px"} width={"300px"}/>}
                    {fileChanged && <Image src={fileDataURL} height={"400px"} width={"300px"}/>}
                </div>
            </Col>
        </div>
        </Container>
